...
var KTDashboard = function () {
    ...
    var widgetTechnologiesChart = function () {
        ...
        var val1 = document.getElementById("picking1").value;;
        var val2 = document.getElementById("picking2").value;;
        var config = {
            type: 'doughnut',
            data: {
                datasets: [{
    ...
    var widgetTechnologiesChart2 = function () {
        ...
        var xval = document.getElementById("packing1").value;
        var xval2 = document.getElementById("packing2").value;
